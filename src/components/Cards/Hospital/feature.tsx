...
export const FeatureCard = ({heading, info}: FeatureContent): JSXElement => {
  return (
    <>
      <div class="flex w-full gap-8 justify-center bg-[#F9FBFE] p-5 rounded-3xl">
        <div class="w-[40%] h-[300px] bg-gray-50">
          <img src="" alt="image" class="w-full h-full" />
        </div>
        <div class="w-[40%] h-[300px] flex flex-col justify-around">
...
export const FeatureCardRev = ({ heading, info }: FeatureContent): JSXElement => {
  return (
    <>
      <div class="flex w-full gap-8 justify-center bg-[#F9FBFE] p-5 rounded-3xl">
        <div class="w-[40%] h-[300px] flex flex-col justify-around">
